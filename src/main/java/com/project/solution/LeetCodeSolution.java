...
public class LeetCodeSolution {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(magnificentSets(6, edges1));

        int[][] edges2 = new int[][]{{1,2},{2,3},{3,1}};
        System.out.println(magnificentSets(3, edges2));
    ...
    private static int getLongestShortestPath(ArrayList<ArrayList<Integer>> adjList, int srcNode, int n) {
    ...
    private static int getNumberOfGroupsForComponent(ArrayList<ArrayList<Integer>> adjList, int node,
